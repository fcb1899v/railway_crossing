...
Future<int> getAndroidSDKVersion() async {
  if (Platform.isIOS || Platform.isMacOS) return 33;
  try {
...
///CountryNumber
Future<int> getDefaultCountryNumber() async {
...
Widget menuTitleText(BuildContext context, String plan) =>
    Container(
      ...
      child: Text(context.currentPlan(plan),
        style: TextStyle(
...
Widget menuWidget(BuildContext context, String plan, int tickets, int countryNumber, int currentDate, int lastClaimedDate, int expirationDate, void Function() toBuyOnetime, toUpgradePlan, toPurchase, toCancel, toRestore) =>
    Container(
      ...
      child: Column(children: [
        ...
        Row(children: [
          if (plan != freeID) menuContactUs(context),
          Spacer(),
        ...
        child: AlertDialog(
          ...
          content: Column(children: [
            ...
            GestureDetector(
              ...
              child: Container(
                margin: EdgeInsets.only(
                  top: context.purchaseUpgradeButtonMarginTop(),
                ),
    ...
    GestureDetector(
      ...
      child: Container(
        margin: EdgeInsets.only(
          ...
          right: (isMenu) ? context.menuOtherSelectMarginRight(): context.purchaseCancelButtonMarginRight(),
        ),
        alignment: Alignment.centerRight,
...
Widget menuContactUs(BuildContext context) =>
    GestureDetector(
      onTap: () => launchUrl(context.contactUrl(), mode: LaunchMode.externalApplication),
      child: Container(
        margin: EdgeInsets.only(
          top: context.menuOtherSelectMarginTop(),
          left: context.menuOtherSelectMarginRight(),
        ),
        alignment: Alignment.centerRight,
