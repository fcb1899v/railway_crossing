...
// App Check. Debug tokens come from .env, never source (public repo); one per platform.
// Register: firebase appcheck:debugtokens:create <token> --app <appId>
...
const generateTrainPhotoRegion = "us-central1";
