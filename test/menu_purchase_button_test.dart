// The one-time menu panel: its purchase button is drawn only from a live store price,
// and without the button the panel shrinks by exactly the button's space (no blank
// strip, top unchanged). MenuButton's wiring and tap guard: menu_button_wiring_test.dart
